...
class OpenRouterModel(BaseLLM):
    ...
    @staticmethod
    def _extract_usage(chat):
        """Extract usage and cost data from an OpenRouter API response."""
        ...
        for attempt in range(max_retries + 1):
            try:
                ...
                if response_format is None:
                    ...
                    # Capture usage for token/cost tracking
                    self._last_usage = self._extract_usage(chat)
